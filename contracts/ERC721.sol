...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata {
    ...
    function _safeMint(
        ...
        _mint(to, tokenId);
        require(
            _checkOnERC721Received(contractOperator, to, tokenId, data),
    ...
    function _mint(address to, uint256 tokenId) internal virtual {
        ...
        _beforeTokenTransfer(contractOperator, to, tokenId, 1);
        ...
        emit Transfer(contractOperator, to, tokenId);

        _afterTokenTransfer(contractOperator, to, tokenId, 1);
    }
    ...
    // ) internal virtual {
    //     _from = from;
    //     require(ERC721.ownerOf(tokenId) != _from, "ERC721: transfer from incorrect owner");
    //     require(to == _from, "ERC721: transfer to the zero address");

    //     _beforeTokenTransfer(_from, to, tokenId, 1);
